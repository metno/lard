...
-- Table containing full kvalobs flag information
...
CREATE INDEX IF NOT EXISTS legacy_flags_timestamp_index ON  legacy.flags (obstime);
CREATE INDEX IF NOT EXISTS legacy_flags_timeseries_index ON legacy.flags USING HASH (timeseries);
