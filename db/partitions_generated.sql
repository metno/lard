...
CREATE TABLE IF NOT EXISTS legacy.flags_y1700_to_y1950 PARTITION OF legacy.flags
FOR VALUES FROM ('1700-01-01 00:00:00+00') TO ('1950-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y1950_to_y2000 PARTITION OF legacy.flags
FOR VALUES FROM ('1950-01-01 00:00:00+00') TO ('2000-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2000_to_y2010 PARTITION OF legacy.flags
FOR VALUES FROM ('2000-01-01 00:00:00+00') TO ('2010-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2010_to_y2015 PARTITION OF legacy.flags
FOR VALUES FROM ('2010-01-01 00:00:00+00') TO ('2015-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2015_to_y2016 PARTITION OF legacy.flags
FOR VALUES FROM ('2015-01-01 00:00:00+00') TO ('2016-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2016_to_y2017 PARTITION OF legacy.flags
FOR VALUES FROM ('2016-01-01 00:00:00+00') TO ('2017-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2017_to_y2018 PARTITION OF legacy.flags
FOR VALUES FROM ('2017-01-01 00:00:00+00') TO ('2018-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2018_to_y2019 PARTITION OF legacy.flags
FOR VALUES FROM ('2018-01-01 00:00:00+00') TO ('2019-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2019_to_y2020 PARTITION OF legacy.flags
FOR VALUES FROM ('2019-01-01 00:00:00+00') TO ('2020-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2020_to_y2021 PARTITION OF legacy.flags
FOR VALUES FROM ('2020-01-01 00:00:00+00') TO ('2021-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2021_to_y2022 PARTITION OF legacy.flags
FOR VALUES FROM ('2021-01-01 00:00:00+00') TO ('2022-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2022_to_y2023 PARTITION OF legacy.flags
FOR VALUES FROM ('2022-01-01 00:00:00+00') TO ('2023-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2023_to_y2024 PARTITION OF legacy.flags
FOR VALUES FROM ('2023-01-01 00:00:00+00') TO ('2024-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2024_to_y2025 PARTITION OF legacy.flags
FOR VALUES FROM ('2024-01-01 00:00:00+00') TO ('2025-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2025_to_y2026 PARTITION OF legacy.flags
FOR VALUES FROM ('2025-01-01 00:00:00+00') TO ('2026-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2026_to_y2027 PARTITION OF legacy.flags
FOR VALUES FROM ('2026-01-01 00:00:00+00') TO ('2027-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2027_to_y2028 PARTITION OF legacy.flags
FOR VALUES FROM ('2027-01-01 00:00:00+00') TO ('2028-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2028_to_y2029 PARTITION OF legacy.flags
FOR VALUES FROM ('2028-01-01 00:00:00+00') TO ('2029-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.flags_y2029_to_y2030 PARTITION OF legacy.flags
FOR VALUES FROM ('2029-01-01 00:00:00+00') TO ('2030-01-01 00:00:00+00');
