...
CREATE TABLE IF NOT EXISTS public.data_yINFINITE_PAST_to_y1700 PARTITION OF public.data
FOR VALUES FROM ('-infinity') TO ('1700-01-01 00:00:00+00');
...
CREATE TABLE IF NOT EXISTS public.data_y2030_to_y2031 PARTITION OF public.data
FOR VALUES FROM ('2030-01-01 00:00:00+00') TO ('2031-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.data_y2031_to_y2032 PARTITION OF public.data
FOR VALUES FROM ('2031-01-01 00:00:00+00') TO ('2032-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.data_y2032_to_y2033 PARTITION OF public.data
FOR VALUES FROM ('2032-01-01 00:00:00+00') TO ('2033-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.data_y2033_to_y2034 PARTITION OF public.data
FOR VALUES FROM ('2033-01-01 00:00:00+00') TO ('2034-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.data_y2034_to_y2035 PARTITION OF public.data
FOR VALUES FROM ('2034-01-01 00:00:00+00') TO ('2035-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.data_y2035_to_yINFINITE_FUTURE PARTITION OF public.data
FOR VALUES FROM ('2035-01-01 00:00:00+00') TO ('infinity');

CREATE TABLE IF NOT EXISTS public.nonscalar_data_yINFINITE_PAST_to_y1700 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('-infinity') TO ('1700-01-01 00:00:00+00');
...
FOR VALUES FROM ('2029-01-01 00:00:00+00') TO ('2030-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2030_to_y2031 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2030-01-01 00:00:00+00') TO ('2031-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2031_to_y2032 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2031-01-01 00:00:00+00') TO ('2032-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2032_to_y2033 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2032-01-01 00:00:00+00') TO ('2033-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2033_to_y2034 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2033-01-01 00:00:00+00') TO ('2034-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2034_to_y2035 PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2034-01-01 00:00:00+00') TO ('2035-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS public.nonscalar_data_y2035_to_yINFINITE_FUTURE PARTITION OF public.nonscalar_data
FOR VALUES FROM ('2035-01-01 00:00:00+00') TO ('infinity');

CREATE TABLE IF NOT EXISTS flags.confident_provenance_yINFINITE_PAST_to_y1700 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('-infinity') TO ('1700-01-01 00:00:00+00');
...
FOR VALUES FROM ('2029-01-01 00:00:00+00') TO ('2030-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2030_to_y2031 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2030-01-01 00:00:00+00') TO ('2031-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2031_to_y2032 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2031-01-01 00:00:00+00') TO ('2032-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2032_to_y2033 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2032-01-01 00:00:00+00') TO ('2033-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2033_to_y2034 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2033-01-01 00:00:00+00') TO ('2034-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2034_to_y2035 PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2034-01-01 00:00:00+00') TO ('2035-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS flags.confident_provenance_y2035_to_yINFINITE_FUTURE PARTITION OF flags.confident_provenance
FOR VALUES FROM ('2035-01-01 00:00:00+00') TO ('infinity');

CREATE TABLE IF NOT EXISTS legacy.data_yINFINITE_PAST_to_y1700 PARTITION OF legacy.data
FOR VALUES FROM ('-infinity') TO ('1700-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y1700_to_y1950 PARTITION OF legacy.data
FOR VALUES FROM ('1700-01-01 00:00:00+00') TO ('1950-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y1950_to_y2000 PARTITION OF legacy.data
FOR VALUES FROM ('1950-01-01 00:00:00+00') TO ('2000-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2000_to_y2010 PARTITION OF legacy.data
FOR VALUES FROM ('2000-01-01 00:00:00+00') TO ('2010-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2010_to_y2015 PARTITION OF legacy.data
FOR VALUES FROM ('2010-01-01 00:00:00+00') TO ('2015-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2015_to_y2016 PARTITION OF legacy.data
FOR VALUES FROM ('2015-01-01 00:00:00+00') TO ('2016-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2016_to_y2017 PARTITION OF legacy.data
FOR VALUES FROM ('2016-01-01 00:00:00+00') TO ('2017-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2017_to_y2018 PARTITION OF legacy.data
FOR VALUES FROM ('2017-01-01 00:00:00+00') TO ('2018-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2018_to_y2019 PARTITION OF legacy.data
FOR VALUES FROM ('2018-01-01 00:00:00+00') TO ('2019-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2019_to_y2020 PARTITION OF legacy.data
FOR VALUES FROM ('2019-01-01 00:00:00+00') TO ('2020-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2020_to_y2021 PARTITION OF legacy.data
FOR VALUES FROM ('2020-01-01 00:00:00+00') TO ('2021-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2021_to_y2022 PARTITION OF legacy.data
FOR VALUES FROM ('2021-01-01 00:00:00+00') TO ('2022-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2022_to_y2023 PARTITION OF legacy.data
FOR VALUES FROM ('2022-01-01 00:00:00+00') TO ('2023-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2023_to_y2024 PARTITION OF legacy.data
FOR VALUES FROM ('2023-01-01 00:00:00+00') TO ('2024-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2024_to_y2025 PARTITION OF legacy.data
FOR VALUES FROM ('2024-01-01 00:00:00+00') TO ('2025-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2025_to_y2026 PARTITION OF legacy.data
FOR VALUES FROM ('2025-01-01 00:00:00+00') TO ('2026-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2026_to_y2027 PARTITION OF legacy.data
FOR VALUES FROM ('2026-01-01 00:00:00+00') TO ('2027-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2027_to_y2028 PARTITION OF legacy.data
FOR VALUES FROM ('2027-01-01 00:00:00+00') TO ('2028-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2028_to_y2029 PARTITION OF legacy.data
FOR VALUES FROM ('2028-01-01 00:00:00+00') TO ('2029-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2029_to_y2030 PARTITION OF legacy.data
FOR VALUES FROM ('2029-01-01 00:00:00+00') TO ('2030-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2030_to_y2031 PARTITION OF legacy.data
FOR VALUES FROM ('2030-01-01 00:00:00+00') TO ('2031-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2031_to_y2032 PARTITION OF legacy.data
FOR VALUES FROM ('2031-01-01 00:00:00+00') TO ('2032-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2032_to_y2033 PARTITION OF legacy.data
FOR VALUES FROM ('2032-01-01 00:00:00+00') TO ('2033-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2033_to_y2034 PARTITION OF legacy.data
FOR VALUES FROM ('2033-01-01 00:00:00+00') TO ('2034-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2034_to_y2035 PARTITION OF legacy.data
FOR VALUES FROM ('2034-01-01 00:00:00+00') TO ('2035-01-01 00:00:00+00');
CREATE TABLE IF NOT EXISTS legacy.data_y2035_to_yINFINITE_FUTURE PARTITION OF legacy.data
FOR VALUES FROM ('2035-01-01 00:00:00+00') TO ('infinity');
